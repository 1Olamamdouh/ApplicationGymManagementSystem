        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Address_BildingNumber = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Email", "Email LIKE '%_@_%.__%' AND CHARINDEX(' ', Email) = 0");
                    table.CheckConstraint("CK_PhoneNumber", "LEFT(PhoneNumber, 2) = '01' AND LEN(PhoneNumber) = 11 AND PhoneNumber NOT LIKE '%[^0-9]%'");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("DurationDaysConstraint", "DurationDays BETWEEN 1 AND 356");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Email1", "Email LIKE '%_@_%.__%' AND CHARINDEX(' ', Email) = 0");
                    table.CheckConstraint("CK_PhoneNumber1", "LEFT(PhoneNumber, 2) = '01' AND LEN(PhoneNumber) = 11 AND PhoneNumber NOT LIKE '%[^0-9]%'");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("Capacity_Constraint", "Capacity between 1 and 25");
                    table.CheckConstraint("End_Constraint", "EndTime > StartTime");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BookingData = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETDATE()"),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
